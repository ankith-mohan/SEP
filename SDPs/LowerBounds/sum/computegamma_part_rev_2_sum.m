%%  COMPUTEGAMMA_PART_REV_2_SUM  Computes the density matrix of the respective subsystems, the optimal value and the number of iterations for revision 2 of the see-saw algorithm
...
%
%   [SIGMA_A, SIGMA_B, GAMMA, I] = computegamma_part_rev_2_sum(K_LIST, 
...
%
%   URL:
%   https://ankith-mohan.github.io/SEP/SDPs/LowerBounds/computegamma_part_rev_2_sum.html
%
