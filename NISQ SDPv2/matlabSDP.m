...
function beta_result = matlabSDP(E_matrix_in, D_matrix_in, shift_value, ...
                                    do_conserved, conserved_number, ...
                                    C_matrix_in, C2_matrix_in)
    ...
    if do_conserved == false
        cvx_begin
            ...
            minimize real(trace(beta_q * D_matrix_sdp));
            subject to
